...
# ===================== VIDEO =====================
#video_path = r"C:\Users\RACHIT\Desktop\Web Dev\parking_lot-main\parking_lot-main\video1.mp4"   # CHANGE IF NEEDED
video_path = r"C:\Users\RACHIT\Desktop\Web Dev\parking_lot-main\parking_lot-main\vecteezy_parking-lot-movement_1623435.mp4"
...
while True:
    ...
    if results_top and results_top[0].boxes is not None:
        ...
        for box in boxes:
            ...
            for poly in polygons:
                pts = get_valid_polygon(poly["points"])
                if pts is None:
                    continue
    ...
    for poly in polygons:
        ...
        x, y = poly["points"][0]
        cv2.putText(frame, poly["id"], (x, y - 8),
    ...
    for poly in polygons:
        ...
        cv2.putText(frame, f"{poly['id']} : {status}",
                    (panel_x, y_offset),
